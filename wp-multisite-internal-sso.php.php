...
add_action('plugins_loaded', 'wpmis_plugin_init');

function wpmis_plugin_init() {
    $GLOBALS['wp_multisite_internal_sso'] = new WP_Multisite_Internal_SSO();
}

add_action( 'wp_body_open', 'wpmis_display_logged_in_status' );

function wpmis_display_logged_in_status() {
